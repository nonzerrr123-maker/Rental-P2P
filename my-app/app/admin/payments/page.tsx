  ...
  return (
    <main className="min-h-screen bg-[#f7f7f5] text-neutral-900">
      ...
      <div className="mx-auto max-w-6xl px-6 py-10">
        <span className="text-xs font-black tracking-[3px] text-[#a58316]">ADMIN / PAYMENTS</span><h1 className="mt-2 text-4xl font-black">การชำระเงินจริงจาก PostgreSQL</h1><p className="mt-2 text-neutral-500">อ่านสถานะ payment/deposit ที่ระบบสร้างจริง ไม่มีปุ่ม Mark paid ฝั่ง UI</p>
