  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-gray-50 px-5 py-10">
      <div className="w-full max-w-md rounded-2xl border bg-white p-8 shadow-sm">
        ...
        <div className="mt-6 rounded-lg border border-[#D4AF37]/40 bg-[#D4AF37]/10 p-3 text-xs text-gray-600">
          บัญชีที่ยังไม่ผ่านการยืนยันตัวตนจะถูกส่งไปหน้า Verification ก่อนจึงจะยืมหรือให้ยืมของได้
        </div>
        <p className="mt-6 text-center text-sm text-gray-500">
          ยังไม่มีบัญชี?{" "}
          <Link href="/register" className="font-bold text-[#B08D18]">
            สมัครสมาชิก
          </Link>
        </p>
      </div>
